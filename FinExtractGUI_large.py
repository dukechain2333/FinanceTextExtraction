...
class Ui_widget(object):
    def setupUi(self, widget):
        ...
        widget.resize(723, 1009)
        self.label = QtWidgets.QLabel(widget)
        self.label.setGeometry(QtCore.QRect(20, 30, 381, 51))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(widget)
        self.label_2.setGeometry(QtCore.QRect(20, 110, 161, 21))
        self.label_2.setObjectName("label_2")
        self.plainTextEdit = QtWidgets.QPlainTextEdit(widget)
        self.plainTextEdit.setGeometry(QtCore.QRect(20, 150, 671, 251))
        self.plainTextEdit.setObjectName("plainTextEdit")
        self.label_3 = QtWidgets.QLabel(widget)
        self.label_3.setGeometry(QtCore.QRect(20, 470, 151, 31))
        self.label_3.setObjectName("label_3")
        self.plainTextEdit_2 = QtWidgets.QPlainTextEdit(widget)
        self.plainTextEdit_2.setGeometry(QtCore.QRect(20, 520, 671, 251))
        self.plainTextEdit_2.setObjectName("plainTextEdit_2")
        self.label_4 = QtWidgets.QLabel(widget)
        self.label_4.setGeometry(QtCore.QRect(20, 820, 141, 41))
        self.label_4.setObjectName("label_4")
        self.lineEdit = QtWidgets.QLineEdit(widget)
        self.lineEdit.setGeometry(QtCore.QRect(170, 820, 231, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.pushButton = QtWidgets.QPushButton(widget)
        self.pushButton.setGeometry(QtCore.QRect(20, 890, 101, 51))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(170, 890, 101, 51))
        ...
        self.label_5.setGeometry(QtCore.QRect(350, 970, 400, 31))
    ...
    def retranslateUi(self, widget):
        ...
        self.label_5.setText(_translate("widget", '第六届汇“汇创青春”上海大学生文化创意作品展示活动参赛作品'))
